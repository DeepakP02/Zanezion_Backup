...
const Projects = () => {
  const { projects, addProject, updateProject, deleteProject, fetchProjects, customerUsers, fetchCustomerUsers, convertProjectToMission, hasMenuPermission, currentUser } = useData();
